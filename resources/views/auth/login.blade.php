...
<div id="loginbox">            
        ...
        <div class="form-actions">
            ...
            <span class="pull-left"><a href="{{ route('register') }}" class="flip-link btn btn-primary">Registrarse</a></span>
            <span class="pull-right"><a type="submit" class="btn btn-success" /> Iniciar Sesion</a></span>
        </div>
    </form>
    <form id="recoverform" action="#" class="form-vertical">
        ...
        <div class="form-actions">
            <span class="pull-left"><a href="#" class="flip-link btn btn-success" id="to-login">&laquo; Volver a Iniciar Sesion</a></span>
